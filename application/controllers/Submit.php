    ...
    private function _upload() {
        ...
        if ($_FILES['userfile']['error'] == 4) {
            ...
            $submit_info = array(
                ...
                'file_name' => 'submission_' . $submit_id,
                'main_file_name' => 'submission_' . $submit_id,
                'file_type' => $this->_language_to_type($this->input->post('language')),
                'coefficient' => $this->coefficient
            );

            if (file_put_contents($user_dir . '/' . $submit_info['file_name'] . '.' . filetype_to_extension($this->_language_to_type($this->input->post('language'))), $this->input->post('code'))) {
